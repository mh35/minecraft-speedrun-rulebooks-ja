# Minecraft: Bedrock Editionスピードラン規則集
...
* [シード値固有の規則](./seed/README.md)
    - [セットシード](./seed/README.md#セットシード)
    - [ランダムシード](./seed/README.md#ランダムシード)
* [構造物](./structures/README.md)
    - [構造物使用](./structures/README.md#構造物使用)
    - [構造物不使用](./structures/README.md#構造物不使用)
* [タッチスクリーンのグリッチ](./tsglitch/README.md)
    - [タッチスクリーンのグリッチなし](./tsglitch/README.md#タッチスクリーンのグリッチなし)
    - [タッチスクリーンのグリッチあり](./tsglitch/README.md#タッチスクリーンのグリッチあり)
